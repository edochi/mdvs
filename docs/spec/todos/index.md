...
| [0092](TODO-0092.md) | Compact JSON output — result-only when no errors | todo | medium | 2026-03-08 |
| [0093](TODO-0093.md) | Verbose text output — process step lines on success | todo | medium | 2026-03-08 |
