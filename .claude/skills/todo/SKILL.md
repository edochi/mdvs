...
Spec TODOs live in `docs/spec/todos/` as individual markdown files with YAML
frontmatter.

## Finding TODOs

- **Index:** `docs/spec/todos/index.md` — Single table sorted by ID with status,
  priority, and dates
...
1. **Derive next ID:** Find the highest existing ID and add 1 (do NOT fill gaps
...
- To spec files: `../terminology.md`, `../storage.md`, `../commands/check.md`,
  `../workflows/inference.md`
